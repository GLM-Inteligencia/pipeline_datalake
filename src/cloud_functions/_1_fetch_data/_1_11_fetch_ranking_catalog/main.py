...
async def main_async(request):
    ...
    # Path for saving 
    blob_basic_path = settings.BLOB_COMPETITORS_CATALOG(store_name)
    ...
    url = settings.URL_COMPETITORS_CATALOG
...
def fetch_ranking_catalog(request):
