...
# from src.cloud_functions.fetch_data.main_shipping_cost import main as main_fetch
# from src.cloud_functions.insert_bq.insert_bq_shipping import main  as main_insert
...
# result = main_insert(mock_request)
